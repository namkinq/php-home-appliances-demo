                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <?php
                            $id=$_GET['id'];
                            $query=mysqli_query($conn,"select * from `don_hang` where MaDonHang='$id'");
                            $row=mysqli_fetch_assoc($query);
                            ?>

                            <form method="POST" class="form">
                            <h3 class="box-title">Sửa trạng thái</h2>                        
                            <label for="">Trạng thái: </label>
                                  <select name="status" id="status" style="min-width: 200px; margin:0 20px">
                                     <option value = "Chờ xử lý"> Chờ xử lý </option> 
                                     <option value = "Đang đóng hàng"> Đang đóng hàng </option> 
                                     <option value = "Đang giao"> Đang giao </option>  
                                     <option value = "Đang giao"> Đã giao </option>  
                                     <option value = "Đang giao"> Hủy </option>               
                            ...
                            if (isset($_POST['update'])){
                                ...
                                if ($conn->connect_error) {
                                    ...
                                    $sql = "UPDATE `don_hang` SET TinhTrang='$status' WHERE MaDonHang='$id'";
