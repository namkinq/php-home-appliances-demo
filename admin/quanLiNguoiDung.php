                        ...
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                <table class="table text-nowrap">
                                    ...
                                    <?php
                                    $query = mysqli_query($conn,"select * from `khach_hang` where Quyen = 0");
                                    $i=1;
                                    ...
                                    <tbody>
                                       ...
                                       <!--    <td><a href="khoaNguoiDung.php?id=<?php echo $row['MaKhachHang']; ?>" onclick="return confirm('Bạn có chắc muốn khóa bản ghi này(Mã = <?php echo $row['MaKhachHang']; ?>)?');">Khóa</a></td> -->
