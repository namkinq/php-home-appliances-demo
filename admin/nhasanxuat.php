                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <a class="btn btn-primary" href="themnhasanxuat.php" role="button">Thêm mới</a>
                            <div class="table-responsive">
                                <table class="table text-nowrap">
                                    ...
                                    <?php
                                    $query = mysqli_query($conn,"select * from `nha_san_xuat`");
                                    $i=1;
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="suanhasanxuat.php?id=<?php echo $row['MaNSX']; ?>">Sửa</a></td>
                                            <td><a href="xoanhasanxuat.php?id=<?php echo $row['MaNSX']; ?>" onclick="return confirm('Bạn có chắc muốn xóa bản ghi này(Mã = <?php echo $row['MaNSX']; ?>)?');">Xóa</a></td>
