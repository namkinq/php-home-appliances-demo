                        ...
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                <table class="table text-nowrap">
                                    ...
                                    <?php
                                    $query = mysqli_query($conn,"SELECT dh.MaDonHang, dh.MaKhachHang, ThoiGianDat, TinhTrang, SUM(SoLuongSP*Gia) 'TongTien' from don_hang dh JOIN chi_tiet_don_hang ctdh ON dh.MaDonHang=ctdh.MaDonHang GROUP BY dh.MaDonHang");
                                    //$query = mysqli_query($conn,"select * from `don_hang`");
                                    $i=1;
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="suadonhang.php?id=<?php echo $row['MaDonHang']; ?>">Sửa trạng thái</a></td>
                                            <td><a href="xoaDonHang.php?id=<?php echo $row['MaDonHang']; ?>" onclick="return confirm('Bạn có chắc muốn hủy đơn hàng này(Mã = <?php echo $row['MaDonHang']; ?>)?');">Hủy</a></td>  
