                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <a class="btn btn-primary" href="themSanPham.php" role="button">Thêm mới</a>
                            <div class="table-responsive">
                                <table class="table text-nowrap">
                                    ...
                                    if(isset($_GET['key'])){
                                        ...
                                        $query = mysqli_query($conn,"SELECT * FROM thiet_bi_dien WHERE TenThietBi LIKE '%$key%'");
                                    }
                                    else{
                                        $query = mysqli_query($conn,"select * from `thiet_bi_dien`");
                                    }
                                    $i=1;
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="suaSanPham.php?id=<?php echo $row['MaThietBi']; ?>">Sửa</a></td>
                                            <td><a href="xoaSanPham.php?id=<?php echo $row['MaThietBi']; ?>" onclick="return confirm('Bạn có chắc muốn xóa bản ghi này(Mã = <?php echo $row['MaThietBi']; ?>)?');">Xóa</a></td>
