                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <?php
                            $id=$_GET['id'];
                            $query=mysqli_query($conn,"select * from `nha_san_xuat` where MaNSX='$id'");
                            $row=mysqli_fetch_assoc($query);
                            ?>

                            <form method="POST" class="form">
                            <h3 class="box-title">Sửa nhà sản xuất</h2>
                            <label>Tên: <input type="text" value="<?php echo $row['TenNSX']; ?>" name="tennsx"></label><br/>
                            ...
                            if (isset($_POST['update'])){
                                ...
                                $mota=$_POST['mota'];
                                // Create connection
                                $conn = new mysqli("localhost", "root", "toilahuy", "data_btl_php");
                                // Check connection
                                if ($conn->connect_error) {
                                    die("Connection failed: " . $conn->connect_error);
                                }
                                    $sql = "UPDATE `nha_san_xuat` SET TenNSX='$ten', MoTa='$mota' WHERE MaNSX='$id'";
