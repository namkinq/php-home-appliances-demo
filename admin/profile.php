            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-12">
                        <div class="white-box">
                            <div class="user-bg"> <!--<img width="100%" alt="user" src="plugins/images/users/10.jpg"> -->
                                <div class="overlay-box">
                                    <div class="user-content">
                                        <a href="javascript:void(0)"><img src="plugins/images/users/1.jpg"
                                                class="thumb-lg img-circle" alt="img"></a>
                                        <h4 class="text-white mt-3"><?php echo $row['TenKhachHang'] ?></h4>
                            ...
                            <div class="user-btm-box mt-5 d-md-flex">
                                ...
                                <div class="col-md-4 col-sm-4 text-center">
                                    <a href="dangxuat.php"><h4>Đăng xuất</h4></a>
                                </div>
                                <div class="col-md-4 col-sm-4 text-center">
                                    <h1></h1>
                                </div>
                                ...
                                <form class="form-horizontal form-material">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name='ht' value="<?php echo $row['TenKhachHang'] ?>"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="password" value="<?php echo $row['MatKhau'] ?>" name="mk" class="form-control p-0 border-0">
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">SĐT</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="sdt" value="<?php echo $row['SoDienThoai'] ?>"
                    ...
                    <?php
                        if (isset($_POST['submit'])){
                            ...
                            $email=$_POST['email'];
                            $sdt=$_POST['sdt'];
                            $sql = "UPDATE khach_hang SET TenKhachHang='$ht', MatKhau='$mk', Email='$email',SoDienThoai='$sdt' WHERE MaKhachHang='$id_kh'";
