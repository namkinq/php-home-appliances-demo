                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <a class="btn btn-primary" href="themDanhMuc.php" role="button">Thêm mới</a>
                            <div class="table-responsive">
                                <table class="table text-nowrap">
                                    ...
                                    <?php
                                    $query = mysqli_query($conn,"select * from `danh_muc`");
                                    $i=1;
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="suanhasanxuat.php?id=<?php echo $row['MaDanhMuc']; ?>">Sửa</a></td>
                                            <td><a href="xoaDanhMuc.php?id=<?php echo $row['MaDanhMuc']; ?>" onclick="return confirm('Bạn có chắc muốn xóa bản ghi này(Mã = <?php echo $row['MaDanhMuc']; ?>)?');">Xóa</a></td>
                                        </tr>
                                    </tbody>
                                    <?php
                                    }
